...
var mgetBusRouteListTagItem = make(map[int]getRouteInfoTag)
...
func getRouteInfo() bool {

	defaulturl := "http://ws.bus.go.kr/api/rest/busRouteInfo/getRouteInfo?"
	...
	if match != nil {
		...
		for _, val := range match {
			...
			mgetBusRouteListTagItem[Index] = getRouteInfoTag{thumb1[0], thumb2[0],
